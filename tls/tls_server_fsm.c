...
error_t tlsPerformServerHandshake(TlsContext *context)
{
   ...
   while(!error)
   {
      ...
      //Sending NewSessionTicket message?
      case TLS_STATE_NEW_SESSION_TICKET_2:
      ...
      //Sending ACK message for client's final flight?
      case TLS_STATE_FINAL_ACK:
